...
// --------------------- END -------------------------
        ...
        <div class='row page-titles mx-0'>
          <div class='col-sm-6 p-md-0'>
            <div class='welcome-text'>
              <h4>Hasil Diagnosa Certainty Factor!</h4>
              <span class='ml-0'>Hasil Diagnosa Penyakit dan Hama Tanaman Bawang Merah</span>
            </div>
          </div>
      ...
      echo "      <div class='callout callout-default'>Jenis penyakit yang dialami adalah <b>
                    <h3 class='text text-success'>" . $nmpkt[1] . "</b> / " . round($vlpkt[1]*100, 0) . " %<br></h3>
                  </div>
                </div>";
            ...
            <div class='card'>
              <div class='card-body'>
                <div class='table-responsive'>
          		    <form name=text_form method=POST action='diagnosacf' >
