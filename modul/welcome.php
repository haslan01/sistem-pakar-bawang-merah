                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            <span class="ml-0">Di sistem pakar diagnosa penyakit tanaman bawang merah</span>
                        </div>
                    </div>
                    ...
                    <!-- <div class="col-sm-12 col-md-12 col-xxl-6 col-xl-4 col-lg-6">
                        <div class="card" style="background-image: url(assets/images/adm_back.svg); height: 89%;">
                            <div class="card-header">
                                ...
                                <div class="ml-2">
                                    <h4 class="location font-weight-normal">Majene</h4>
                                    ...
                                    <div class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img class="d-block w-100" src="assets/images/banner/banner1.png" alt="First slide">
                                            </div>
                                            <div class="carousel-item">
                                                <img class="d-block w-100" src="assets/images/banner/banner2.png" alt="Second slide">
                                            </div>
                                        </div>
                                    </div>
                                </div>
