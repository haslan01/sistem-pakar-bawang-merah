  ...
  <div class="row page-titles mx-0">
    <div class="col-sm-6 p-md-0">
      <div class="welcome-text">
        ...
        <span class="ml-0">Hasil Diagnosa Gejala Penyakit Tanaman bawang merah</span>
      </div>
    </div>
  </div>
  <?php
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                      <span class="mr-2">
                        <i class="fa fa-circle turquoise"></i> Antraknose
                      </span>
                      <span class="mr-2">
                        <i class="fa fa-circle emerald"></i> Twisting Disease
                      </span>
                      <span class="mr-2">
                        <i class="fa fa-circle river"></i> Downy Mildew
                      </span>
                      <span class="mr-2">
                        <i class="fa fa-circle amethyst"></i> Cercospora Leaf Spot
                      </span>
                      <span class="mr-2">
                        <i class="fa fa-circle asphalt"></i> Plternari Porri
                      </span>
                      <span class="mr-2">
                        <i class="fa fa-circle sun"></i> Phytohthora Porri
                      </span>
                    </div>
