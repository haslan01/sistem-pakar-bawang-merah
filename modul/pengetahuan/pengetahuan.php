			...
			<div class='row page-titles mx-0'>
			    <div class='col-sm-6 p-md-0'>
				    <div class='welcome-text'>
				        ...
				        <span class='ml-0'>Pengolahan Basis Pengetahuan Penyakit Tanaman Bawang Merah</span>
				    </div>
			    </div>
		...
		<div class='container-fluid'>     
			<div class='row page-titles mx-0'>
			    <div class='col-sm-6 p-md-0'>
				    <div class='welcome-text'>
				        <h4>Basis Pengetahuan</h4>
				        <span class='ml-0'>Tambah basis pengetahuan penyakit tanaman Bawang Merah</span>
				    </div>
			    </div>
			</div>
			<div class='row'>
	    ...
	    <div class='container-fluid'>     
			<div class='row page-titles mx-0'>
			    <div class='col-sm-6 p-md-0'>
				    <div class='welcome-text'>
				        <h4>Basis Pengetahuan</h4>
				        <span class='ml-0'>Ubah basis pengetahuan penyakit tanaman Bawang Merah</span>
				    </div>
			    </div>
			</div>
			<div class='row'>
