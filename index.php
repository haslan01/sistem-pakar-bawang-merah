...
<head>
    ...
    <base href="http://localhost/sistem-pakar-bawang-merah/">
	  <!-- Favicon icon -->
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="assets/" class="brand-logo">
                <img class="logo-abbr" src="assets/images/bawang.png" alt="">
                <img class="logo-compact" src="assets/images/logotext1.png" alt="">
                <img class="brand-title" src="assets/images/logotext1.png" alt="">
            </a>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="#" target="_blank">Adliana</a> 2022</p>
            </div>
        </div>
        <!--**********************************
            Footer end
